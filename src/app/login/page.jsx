   ...
   const handleLoginWithGoogle = async () => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          // BENAR: Beritahu Supabase ke mana harus kembali SETELAH SEMUA PROSES SELESAI
          // `location.origin` akan otomatis menjadi https://www.smartvitae.my.id saat di-deploy
